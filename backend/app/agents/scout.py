...
Sources:
  1. Curated Caribbean opportunities database (clubs, competitions, events)
  2. LLM-powered recommendation from user profile

Caribbean focus:
  - Opportunities tagged by country/region (CARICOM-wide, Jamaica, Barbados, etc.)
